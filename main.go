...
func initDB() {
	var err error
	// Ganti parameter koneksi sesuai dengan koneksi PostgreSQL Anda
	dataSourceName := "host=localhost port=5432 user=postgres dbname=rest_api password=KAK14semangat sslmode=disable"
	...
	// Migration untuk membuat tabel Order dan Item
